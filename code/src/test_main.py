...
def parse_args():
    ...
    simulate.add_argument('--evidence', type=str, default='visual', choices=['visual', 'audio'], help='which evidence to use (default: `visual`)')
    ...
    empirical.add_argument('--evidence', type=str, default='visual', choices=['visual', 'audio'], help='which evidence to use (default: `visual`)')
    ...
    uniform.add_argument('--evidence', type=str, default='visual', choices=['visual', 'audio'], help='which evidence to use (default: `visual`)')
...
if __name__ == '__main__':
    ...
    params_dict_for_metadata.pop('naive_A_visual_likelihoods_map', None)
    params_dict_for_metadata.pop('naive_B_visual_likelihoods_map', None)
    params_dict_for_metadata.pop('naive_A_audio_sequences', None)
    params_dict_for_metadata.pop('naive_B_audio_sequences', None)
